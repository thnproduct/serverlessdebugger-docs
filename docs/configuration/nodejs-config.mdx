...
```
- Latest version of the Serverless Debugger Nodejs Layer ![Serverless Debugger Nodejs Layer](https://api.globadge.com/v1/badgen/aws/lambda/layer/latest-version/us-west-2/545538059309/slsdebugger-nodejs)
