...
[Using Lambda Layer](#using-serverless-debugger-lambda-layer) or 
...
### Using ServerlessDebugger Lambda Layer

- Add ServerlessDebugger lambda layer!
```
arn:aws:lambda:${region}:545538059309:layer:slsdebugger-nodejs:${latest-version} 
```
- Latest version of the ServerlessDebugger Nodejs Layer ![ServerlessDebugger Nodejs Layer](https://api.globadge.com/v1/badgen/aws/lambda/layer/latest-version/us-west-2/545538059309/slsdebugger-nodejs)
...
- Set `NODE_OPTIONS` to `-r @thundra/slsdebugger/dist/bootstrap/lambda` in environment variable.

#### Integrate with Handler Switch

- Set `SLSDEBUGGER_LAMBDA_HANDLER` to your lambda handler in environment variable.

- Set lambda handler to  `slsdebugger_handler.wrapper`
...
* Join our [Discord](https://www.serverlessdebugger.com/discord-invitation)


## Opening Issues

For any problem you encounter while using ServerlessDebugger Node.js, Please feel free to contact us via our Discord channel. 