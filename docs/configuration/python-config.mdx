...
Debug your marvelous Python Lambda with ServerlessDebugger by [Thundra](https://www.serverlessdebugger.com)!
...
```
- Latest version: ![Serverless Debugger Python Layer](https://api.globadge.com/v1/badgen/aws/lambda/layer/latest-version/us-west-2/545538059309/slsdebugger-python)
...
* Open an issue in [GitHub](https://github.com/serverlessdebugger/serverlessdebugger-issues).
* Join our Python [Discord channel](https://www.serverlessdebugger.com/discord-invitation).
