...
frogate's VS Code extension allows you to debug your AWS Lambda functions. It currently supports NodeJS and Python runtimes. With a small configuration, debugging is as simple as a click of a button.
